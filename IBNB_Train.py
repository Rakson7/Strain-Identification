...
def parse_command(model):
    ...
    parser.add_option("--klen", type="int", dest="klen", help="Length of Kmer to train.(can take values 8 to 24,suggested 14 to 20) [default=16]", default=16)
    parser.add_option("--hklen", type="int", dest="hklen", help="Length of Kmer to train.(max same as klen, suggested half of klen) [default=8]",default=8)    
    ...
    if options.klen<8 or options.klen>24 :parser.error("klen can take values 8 to 24.(Suggested 14 to 20)")
